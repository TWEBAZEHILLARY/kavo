  ...
  function HomeA() {
    ...
    return (
      <div style={{ fontFamily: F, background: '#fff', color: T.ink, width: '100%', WebkitFontSmoothing: 'antialiased' }}>
        ...
        {/* hero */}
        <div style={{ padding: '24px 40px 0', display: 'grid', gridTemplateColumns: '236px 1fr', gap: 18 }}>
          ...
          <div style={{ borderRadius: 16, overflow: 'hidden', position: 'relative', background: `linear-gradient(120deg, ${T.blueDk}, ${T.blue})`, color: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '54px 60px', minHeight: 392 }}>
            <HeroSlideshow />
            ...
            <div style={{ fontSize: 54, fontWeight: 800, lineHeight: 1.06, letterSpacing: -1.4, maxWidth: 620, position: 'relative', zIndex: 2 }}>Every component your project runs on.</div>
            <div style={{ fontSize: 19, color: 'rgba(255,255,255,.85)', margin: '16px 0 30px', maxWidth: 560, lineHeight: 1.5, position: 'relative', zIndex: 2 }}>Genuine ABB, Schneider & Siemens stock — priced in UGX, USD or EUR with same-day Kampala dispatch.</div>
